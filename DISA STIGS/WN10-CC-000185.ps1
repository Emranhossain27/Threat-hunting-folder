<#
.SYNOPSIS
    This PowerShell script configures the system to prevent AutoRun commands from executing by setting the NoAutorun registry value.
...
Write-Output "Default AutoRun behavior configured to prevent autorun commands."
